      ...
      <section id="projects" className="section-block">
        <div className="page-shell">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-[0.92fr_1.08fr] lg:items-stretch">
            <div className="featured-project-list grid gap-4 lg:self-stretch">
    ...
    >
      ...
      >
        <div className="flex min-h-0 flex-1 flex-col">
          ...
          <p
            className={cn(
              "project-card-summary mt-2 text-sm leading-6",
              isActive ? "text-white/72" : "text-muted"
            )}
          >
            {project.summary}
          </p>
          <div className="featured-project-facts mt-4 grid gap-2 sm:grid-cols-2">
              ...
              <span
                ...
                className={cn(
                  ...
                  isActive
                    ...
                    : "border-soft bg-violet-soft"
                )}
              >
                <span
                  className={cn(
                    "block text-[0.65rem] font-black uppercase",
                    isActive ? "text-violet-on-dark" : "text-violet-dark"
                  )}
                >
                  {fact.label}
                </span>
                <span
                  className={cn(
                    "mt-1 block text-xs font-bold leading-4",
                    isActive ? "text-white" : "text-ink"
                  )}
                >
                  {fact.value}
