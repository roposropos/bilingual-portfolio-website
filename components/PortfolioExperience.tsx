...
export function PortfolioExperience({
  ...
  return (
    <main>
      ...
      <section id="stack" className="border-y border-soft bg-white/50 py-20 md:py-28">
        <div className="page-shell">
          <SectionHeading
...
function Hero({
  ...
  return (
    <section className="relative min-h-[86svh] overflow-hidden bg-[#0c0a14] text-white">
      ...
      <div id="top" className="relative z-10">
        <div className="page-shell grid min-h-[calc(86svh-88px)] items-center gap-10 py-16 lg:grid-cols-[1.08fr_0.92fr]">
          <motion.div
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                href="#projects"
                className="focus-ring inline-flex items-center gap-2 rounded-md bg-white px-4 py-3 text-sm font-bold text-ink transition hover:-translate-y-0.5 hover-bg-violet-ghost"
              >
              ...
              <a
                ...
                download
                className="focus-ring inline-flex items-center gap-2 rounded-md border border-white/25 bg-white/10 px-4 py-3 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-white/15"
              >
...
function RecruiterStrip({
  ...
  return (
    <section className="relative z-20 -mt-10 pb-10">
      <div className="page-shell">
        <div className="card grid gap-px overflow-hidden bg-line-dark md:grid-cols-3">
          {content.recruiterStrip.items.map((item) => {
            ...
            return (
              <div key={item.label} className="bg-surface-strong p-5">
  ...
  return (
    ...
    >
      <button
        ...
        onClick={onSelect}
        className={cn(
          "focus-ring card group w-full p-5 text-left transition hover:-translate-y-1 hover:shadow-xl",
      ...
      >
        <div className="min-w-0">
          ...
          <h3
            className={cn(
              "text-xl font-black leading-tight text-ink",
              project.shortTitle.toLowerCase() !== project.title.toLowerCase()
                ? "mt-3"
                : "mt-4"
            )}
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.article
        ...
        className="card p-6 lg:sticky lg:top-5"
      >
        <div>
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
...
function LiveGithubRepositories({
  ...
  return (
    <section className="mt-14 border-t border-soft pt-10">
...
function Contact({ content }: { content: PortfolioContent }) {
  ...
  return (
    <section id="contact" className="bg-ink py-20 text-white md:py-24">
      <div className="page-shell">
